# File name: multiTask.mk
# Autogenerated on: 23-Apr-2016 15:50:02
...
SOURCE_FILES        := $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\multiTask.c) $(call FORMAT_PATH,.\multiTask_data.c) $(call FORMAT_PATH,.\MW_led.c) $(call FORMAT_PATH,.\linuxUDP.c)
HEADER_FILES        := $(call FORMAT_PATH,.\multiTask.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"E:/MATLAB/SupportPackages/R2015b/linux/toolbox/realtime/targets/linux/include" -I"E:/Documents/GIT/QuadCopter/multitask/multiTask_rtt" -I"E:/Documents/GIT/QuadCopter/multitask" -I"C:/Program Files/MATLAB/R2015b/extern/include" -I"C:/Program Files/MATLAB/R2015b/simulink/include" -I"C:/Program Files/MATLAB/R2015b/rtw/c/src" -I"C:/Program Files/MATLAB/R2015b/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2015b/rtw/c/ert" -I"E:/MATLAB/SupportPackages/R2015b/linux/toolbox/realtime/targets/linux/blocks/mex/../sfcn/include" -I"E:/MATLAB/SupportPackages/R2015b/linux/toolbox/realtime/targets/linux/blocks/mex/../sfcn/src" -I"C:/Program Files/MATLAB/R2015b/toolbox/shared/dspblks/extern/include" -O3 -D"MODEL=multiTask" -D"NUMST=2" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=1" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_="
