...
typedef struct {
  real32_T UDPReceive_o1[64];          /* '<Root>/UDP Receive' */
  real32_T Init;                       /* '<S3>/Init' */
  real32_T Xnew;                       /* '<S3>/Reset' */
  real32_T Selector;                   /* '<S4>/Selector' */
  real32_T Selector1;                  /* '<S4>/Selector1' */
  real32_T Selector2;                  /* '<S4>/Selector2' */
  ...
  boolean_T Compare_p;                 /* '<S5>/Compare' */
} B_udpRead_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData[3];
  } Scope2_PWORK_e;                    /* '<S4>/Scope2' */

  real32_T FixPtUnitDelay1_DSTATE;     /* '<S3>/FixPt Unit Delay1' */
  real32_T TappedDelay_X[4];           /* '<S2>/Tapped Delay' */
 ...
 * '<S5>'   : 'udpRead/Enabled Subsystem/For Iterator Subsystem/Compare To Constant'
 */
