...
void baseRateTask(void *arg)
{
  ...
  while ((rtmGetErrorStatus(flightControl_M) == (NULL)) && !rtmGetStopRequested
         (flightControl_M) ) {
...
int main(int argc, char **argv)
{
  ...
  if (rtmGetErrorStatus(flightControl_M) != NULL) {
    printf("\n**%s**\n", rtmGetErrorStatus(flightControl_M));
  }
