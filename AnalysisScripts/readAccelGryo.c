 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Fri Apr 29 15:37:35 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME readAccelGryo
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  9 */
#define OUT_PORT_9_NAME      DataSamples
#define OUTPUT_9_WIDTH       1
#define OUTPUT_DIMS_9_COL    1
#define OUTPUT_9_DTYPE       uint32_T
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint32_T        *DataSamples  = (uint32_T *)ssGetOutputPortRealSignal(S,9);
    const real_T   *xD = ssGetDiscStates(S);

    readAccelGryo_Outputs_wrapper(AccelX, AccelY, AccelZ, GyroX, GyroY, GyroZ, MagX, MagY, MagZ, DataSamples, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    readAccelGryo_Update_wrapper(AccelX, AccelY, AccelZ, GyroX, GyroY, GyroZ, MagX, MagY, MagZ, DataSamples,  xD);
}
