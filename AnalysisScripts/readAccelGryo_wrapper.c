...
#define Mres 10.0*4219.0/32760.0 // 16Bit Proper scale to return milliGauss
 ...
 *
 */
void readAccelGryo_Outputs_wrapper(real32_T *AccelX,
			real32_T *AccelY,
			real32_T *AccelZ,
			real32_T *GyroX,
			real32_T *GyroY,
...
/*
  ...
  *
  */
void readAccelGryo_Update_wrapper(const real32_T *AccelX,
