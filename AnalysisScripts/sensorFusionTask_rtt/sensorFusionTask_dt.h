 ...
 * C source code generated on : Sun May 15 18:11:44 2016
 *
...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&sensorFusionTask_B.UDPReceive_o1[0]), 1, 0, 77 },

  { (char_T *)(&sensorFusionTask_B.UDPReceive_o2), 5, 0, 1 },

  { (char_T *)(&sensorFusionTask_B.Compare), 8, 0, 1 }
  ,

  { (char_T *)(&sensorFusionTask_DW.UDPReceive_NetworkLib[0]), 0, 0, 137 },

  { (char_T *)(&sensorFusionTask_DW.Scope_PWORK.LoggedData), 11, 0, 10 },

  { (char_T *)(&sensorFusionTask_DW.FixPtUnitDelay1_DSTATE), 1, 0, 11 },

  { (char_T *)(&sensorFusionTask_DW.count), 7, 0, 2 },
