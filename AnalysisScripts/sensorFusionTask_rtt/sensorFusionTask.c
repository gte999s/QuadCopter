...
void sensorFusionTask_output(void)
{
  ...
  if (sensorFusionTask_B.Compare) {
     ...
     */
    for (i = 0; i < 12; i++) {
      magInterp[i] = rtb_MatrixConcatenate1[i];
    }

    /* MATLAB Function 'runSensorFusion/calibrateSensorData/calibrate': '<S10>:1' */
    if ((real_T)sensorFusionTask_DW.count_m >= sensorFusionTask_P.Constant_Value)
    {
      /* '<S10>:1:10' */
      /* '<S10>:1:11' */
      sensorFusionTask_B.cal_p[0] = rtb_MatrixConcatenate1[0] -
        sensorFusionTask_DW.bias_c[0];
      sensorFusionTask_B.cal_p[3] = rtb_MatrixConcatenate1[3] -
        sensorFusionTask_DW.bias_c[0];
      sensorFusionTask_B.cal_p[6] = rtb_MatrixConcatenate1[6] -
        sensorFusionTask_DW.bias_c[0];
      sensorFusionTask_B.cal_p[9] = rtb_MatrixConcatenate1[9] -
        sensorFusionTask_DW.bias_c[0];
      sensorFusionTask_B.cal_p[1] = rtb_MatrixConcatenate1[1] -
        sensorFusionTask_DW.bias_c[1];
      sensorFusionTask_B.cal_p[4] = rtb_MatrixConcatenate1[4] -
        sensorFusionTask_DW.bias_c[1];
      sensorFusionTask_B.cal_p[7] = rtb_MatrixConcatenate1[7] -
        sensorFusionTask_DW.bias_c[1];
      sensorFusionTask_B.cal_p[10] = rtb_MatrixConcatenate1[10] -
        sensorFusionTask_DW.bias_c[1];
      sensorFusionTask_B.cal_p[2] = rtb_MatrixConcatenate1[2] -
        sensorFusionTask_DW.bias_c[2];
      sensorFusionTask_B.cal_p[5] = rtb_MatrixConcatenate1[5] -
        sensorFusionTask_DW.bias_c[2];
      sensorFusionTask_B.cal_p[8] = rtb_MatrixConcatenate1[8] -
        sensorFusionTask_DW.bias_c[2];
      sensorFusionTask_B.cal_p[11] = rtb_MatrixConcatenate1[11] -
        sensorFusionTask_DW.bias_c[2];
    } else {
      /* '<S10>:1:13' */
      for (i = 0; i < 12; i++) {
        sensorFusionTask_B.cal_p[i] = 0.0F;
      }
      ...
      for (i = 0; i < 4; i++) {
        ...
        /* '<S10>:1:16' */
        R_idx_2 = 1.0F / sensorFusionTask_P.Constant_Value;
        sensorFusionTask_DW.bias_c[0] += magInterp[3 * i] * R_idx_2;
        sensorFusionTask_DW.bias_c[1] += magInterp[3 * i + 1] * R_idx_2;
        sensorFusionTask_DW.bias_c[2] += magInterp[3 * i + 2] * R_idx_2;

        /* '<S10>:1:17' */
        qY = sensorFusionTask_DW.count_m + 1U;
        if (qY < sensorFusionTask_DW.count_m) {
          qY = MAX_uint32_T;
        }

        sensorFusionTask_DW.count_m = qY;

        /* '<S10>:1:14' */
      }
    }

    /* End of MATLAB Function: '<S7>/calibrate' */
    /* '<S10>:1:20' */
     ...
     *  Constant: '<S7>/Constant'
     */
    /* MATLAB Function 'runSensorFusion/calibrateSensorData/calibrate1': '<S11>:1' */
    if ((real_T)sensorFusionTask_DW.count >= sensorFusionTask_P.Constant_Value)
    {
      /* '<S11>:1:10' */
      /* '<S11>:1:11' */
      sensorFusionTask_B.cal[0] = rtb_MatrixConcatenate1[0] -
        sensorFusionTask_DW.bias[0];
      sensorFusionTask_B.cal[3] = rtb_MatrixConcatenate1[3] -
        sensorFusionTask_DW.bias[0];
      sensorFusionTask_B.cal[6] = rtb_MatrixConcatenate1[6] -
        sensorFusionTask_DW.bias[0];
      sensorFusionTask_B.cal[9] = rtb_MatrixConcatenate1[9] -
        sensorFusionTask_DW.bias[0];
      sensorFusionTask_B.cal[1] = rtb_MatrixConcatenate1[1] -
        sensorFusionTask_DW.bias[1];
      sensorFusionTask_B.cal[4] = rtb_MatrixConcatenate1[4] -
        sensorFusionTask_DW.bias[1];
      sensorFusionTask_B.cal[7] = rtb_MatrixConcatenate1[7] -
        sensorFusionTask_DW.bias[1];
      sensorFusionTask_B.cal[10] = rtb_MatrixConcatenate1[10] -
        sensorFusionTask_DW.bias[1];
      sensorFusionTask_B.cal[2] = rtb_MatrixConcatenate1[2] -
        sensorFusionTask_DW.bias[2];
      sensorFusionTask_B.cal[5] = rtb_MatrixConcatenate1[5] -
        sensorFusionTask_DW.bias[2];
      sensorFusionTask_B.cal[8] = rtb_MatrixConcatenate1[8] -
        sensorFusionTask_DW.bias[2];
      sensorFusionTask_B.cal[11] = rtb_MatrixConcatenate1[11] -
        sensorFusionTask_DW.bias[2];
    } else {
      /* '<S11>:1:13' */
      for (i = 0; i < 12; i++) {
        sensorFusionTask_B.cal[i] = 0.0F;
      }
      ...
      for (i = 0; i < 4; i++) {
        ...
        /* '<S11>:1:15' */
        R_idx_2 = 1.0F / sensorFusionTask_P.Constant_Value;
        sensorFusionTask_DW.bias[0] += rtb_MatrixConcatenate1[3 * i] * R_idx_2;
        sensorFusionTask_DW.bias[1] += rtb_MatrixConcatenate1[3 * i + 1] *
          R_idx_2;
        sensorFusionTask_DW.bias[2] += rtb_MatrixConcatenate1[3 * i + 2] *
          R_idx_2;

        /* '<S11>:1:16' */
        qY = sensorFusionTask_DW.count + 1U;
        if (qY < sensorFusionTask_DW.count) {
          qY = MAX_uint32_T;
        }

        sensorFusionTask_DW.count = qY;

        /* '<S11>:1:14' */
      }
    }

    /* End of MATLAB Function: '<S7>/calibrate1' */
    /* '<S11>:1:19' */
    ...
    /* '<S8>:1:10' */
    for (i = 0; i < 3; i++) {
      varargin_2[i << 1] = sensorFusionTask_B.MatrixConcatenate[i];
      varargin_2[1 + (i << 1)] = sensorFusionTask_B.MatrixConcatenate[i + 3];
    }

    for (i = 0; i < 12; i++) {
      rtb_MatrixConcatenate1[i] = (rtNaNF);
    }
    ...
    for (i = 0; i < 4; i++) {
      ...
      /* '<S8>:1:12' */
      /* '<S8>:1:14' */
      tmp[0] = sensorFusionTask_B.cal_p[3 * i];
      magInterp_0[0] = magInterp[3 * i];
      tmp[1] = sensorFusionTask_B.cal_p[3 * i + 1];
      magInterp_0[1] = magInterp[3 * i + 1];
      tmp[2] = sensorFusionTask_B.cal_p[3 * i + 2];
      magInterp_0[2] = magInterp[3 * i + 2];
      sensorFusionTa_runMadwickUpdate(sensorFusionTask_DW.qLocal, tmp,
        *(real32_T (*)[3])&sensorFusionTask_B.cal[3 * i], magInterp_0,
        sensorFusionTask_P.Constant2_Value, sensorFusionTask_B.q);
   ...
   */
  if (sensorFusionTask_B.Compare || (sensorFusionTask_DW.FixPtUnitDelay2_DSTATE
       != 0)) {
  ...
  if (sensorFusionTask_B.Compare) {
    ...
    sensorFusionTask_B.Xnew = (real32_T)!sensorFusionTask_B.Compare +
...
void sensorFusionTask_initialize(void)
{
  ...
  /* External mode info */
  sensorFusionTask_M->Sizes.checksums[0] = (1038172105U);
  sensorFusionTask_M->Sizes.checksums[1] = (1313001518U);
  sensorFusionTask_M->Sizes.checksums[2] = (1147261987U);
  sensorFusionTask_M->Sizes.checksums[3] = (752511976U);
...

  {
    ...
    sensorFusionTask_DW.count_m = 1U;

    /* InitializeConditions for MATLAB Function: '<S7>/calibrate1' */
    sensorFusionTask_DW.count = 1U;

    /* InitializeConditions for MATLAB Function: '<S7>/calibrate' */
    sensorFusionTask_DW.bias_c[0] = 0.0F;

    /* InitializeConditions for MATLAB Function: '<S7>/calibrate1' */
    sensorFusionTask_DW.bias[0] = 0.0F;

    /* InitializeConditions for MATLAB Function: '<S7>/calibrate' */
    sensorFusionTask_DW.bias_c[1] = 0.0F;

    /* InitializeConditions for MATLAB Function: '<S7>/calibrate1' */
    sensorFusionTask_DW.bias[1] = 0.0F;

    /* InitializeConditions for MATLAB Function: '<S7>/calibrate' */
    sensorFusionTask_DW.bias_c[2] = 0.0F;

    /* InitializeConditions for MATLAB Function: '<S7>/calibrate1' */
    sensorFusionTask_DW.bias[2] = 0.0F;
