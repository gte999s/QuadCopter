...
/* Block signals for system '<S7>/calibrate' */
typedef struct {
  real32_T cal[12];                    /* '<S7>/calibrate' */
  real32_T biasOut[3];                 /* '<S7>/calibrate' */
} B_calibrate_sensorFusionTask_T;

/* Block states (auto storage) for system '<S7>/calibrate' */
typedef struct {
  real32_T bias[3];                    /* '<S7>/calibrate' */
  uint32_T count;                      /* '<S7>/calibrate' */
} DW_calibrate_sensorFusionTask_T;
...
typedef struct {
  ...
  B_calibrate_sensorFusionTask_T sf_calibrate1;/* '<S7>/calibrate1' */
  B_calibrate_sensorFusionTask_T sf_calibrate;/* '<S7>/calibrate' */
...
typedef struct {
  ...
  DW_calibrate_sensorFusionTask_T sf_calibrate1;/* '<S7>/calibrate1' */
  DW_calibrate_sensorFusionTask_T sf_calibrate;/* '<S7>/calibrate' */
