 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon Mar 28 20:18:01 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_MPU6050
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sf_MPU6050_Outputs_wrapper(gx, gy, gz, ax, ay, az, xD);
