 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon Mar 28 20:26:25 2016
*/
...
extern void readAccel_Outputs_wrapper(int16_T *AccelX,
			int16_T *AccelY,
			int16_T *AccelZ,
			const real_T *xD);
extern void readAccel_Update_wrapper(const int16_T *AccelX,
...
{
    int16_T        *AccelX  = (int16_T *)ssGetOutputPortRealSignal(S,0);
    int16_T        *AccelY  = (int16_T *)ssGetOutputPortRealSignal(S,1);
    int16_T        *AccelZ  = (int16_T *)ssGetOutputPortRealSignal(S,2);
    const real_T   *xD = ssGetDiscStates(S);

    readAccel_Outputs_wrapper(AccelX, AccelY, AccelZ, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    readAccel_Update_wrapper(AccelX, AccelY, AccelZ,  xD);
}
