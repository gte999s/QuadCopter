...
HEADER_FILES        := $(call FORMAT_PATH,./ext_svr.h) $(call FORMAT_PATH,./ext_work.h) $(call FORMAT_PATH,./updown.h) $(call FORMAT_PATH,./rtiostream_utils.h) $(call FORMAT_PATH,./readRegisterTest.h)
LIBRARY_FILES       := 
