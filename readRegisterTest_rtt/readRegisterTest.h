...
typedef struct {
  real32_T SFunctionBuilder_o1[50];    /* '<Root>/S-Function Builder' */
  real32_T SFunctionBuilder_o2[50];    /* '<Root>/S-Function Builder' */
  real32_T SFunctionBuilder_o3[50];    /* '<Root>/S-Function Builder' */
  real32_T SFunctionBuilder_o4[50];    /* '<Root>/S-Function Builder' */
  real32_T SFunctionBuilder_o5[50];    /* '<Root>/S-Function Builder' */
  real32_T SFunctionBuilder_o6[50];    /* '<Root>/S-Function Builder' */
  real32_T SFunctionBuilder_o7;        /* '<Root>/S-Function Builder' */
