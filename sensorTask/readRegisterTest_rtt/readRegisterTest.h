...
typedef struct {
  real32_T readAccelGyroMagSfun_o1[50];/* '<S1>/readAccelGyroMagSfun' */
  real32_T readAccelGyroMagSfun_o2[50];/* '<S1>/readAccelGyroMagSfun' */
  real32_T readAccelGyroMagSfun_o3[50];/* '<S1>/readAccelGyroMagSfun' */
  real32_T readAccelGyroMagSfun_o4[50];/* '<S1>/readAccelGyroMagSfun' */
  real32_T readAccelGyroMagSfun_o5[50];/* '<S1>/readAccelGyroMagSfun' */
  real32_T readAccelGyroMagSfun_o6[50];/* '<S1>/readAccelGyroMagSfun' */
  real32_T readAccelGyroMagSfun_o7;    /* '<S1>/readAccelGyroMagSfun' */
  real32_T readAccelGyroMagSfun_o8;    /* '<S1>/readAccelGyroMagSfun' */
  real32_T readAccelGyroMagSfun_o9;    /* '<S1>/readAccelGyroMagSfun' */
  real32_T TmpSignalConversionAtUDPSendInp[304];
  uint32_T readAccelGyroMagSfun_o10;   /* '<S1>/readAccelGyroMagSfun' */
} B_readRegisterTest_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T readAccelGyroMagSfun_DSTATE;  /* '<S1>/readAccelGyroMagSfun' */
 ...
 * '<S1>'   : 'readRegisterTest/readSensors'
 */
